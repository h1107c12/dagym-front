...
import { useAuth } from '../src/context/AuthContext'; // ✅ 추가
...
const Avatar = styled.View`
  ...
  background:#e9f0ff;align-items:center;justify-content:center;
`;
...
const RowPress = styled.Pressable<RowPressProps>`
  ...
  background:${(p:RowPressProps)=> (p.active ? '#f5f8ff' : 'transparent')};
`;
const Bullet = styled.View<RowPressProps>`
  width:8px;height:8px;border-radius:4px;
  background:${(p:RowPressProps)=> (p.active ? '#99B7E8' : '#E0E0EA')};
  margin-right:2px;
`;
    ...
    <Page>
      ...
      <TopBar>
        <BackBtn onPress={() => (nav as any).goBack()}>
          <Ionicons name="chevron-back" size={22} color="#99B7E8" />
        </BackBtn>
        <HeaderTextCol>
      ...
      <Container>
        ...
        <Card>
          <ProfileRow>
            <Avatar>
              <Ionicons name="person" size={22} color="#99B7E8" />
            </Avatar>
            <View style={{ flex: 1 }}>
              {/* ✅ 이름/이메일 표시 */}
              <Name>{displayName}</Name>
              <Sub>{email || '이메일 미설정'}</Sub>
            </View>
          </ProfileRow>
        </Card>
        ...
        <Card>
          <TitleRow>
            <Ionicons name="color-palette-outline" size={16} color="#99B7E8" />
            <Title>테마 설정</Title>
          </TitleRow>

          <RowPress active={mode==='light'} onPress={() => onPick('light')}>
            <Bullet active={mode==='light'} />
            <Ionicons name="sunny-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>라이트 모드</Label>
          ...
          <RowPress active={mode==='dark'} onPress={() => onPick('dark')}>
            ...
            <Ionicons name="moon-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>다크 모드</Label>
          ...
          <RowPress active={mode==='system'} onPress={() => onPick('system')}>
            ...
            <Ionicons name="phone-portrait-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>시스템 기본값</Label>
        ...
        <Card>
          <TitleRow>
            <Ionicons name="notifications-outline" size={16} color="#99B7E8" />
            <Title>알림 설정</Title>
          </TitleRow>

          <RowPress onPress={() => Alert.alert('운동 알림', '운동 알림 설정 화면 연결')}>
            <Ionicons name="barbell-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>운동 알림</Label>
          ...
          <RowPress onPress={() => Alert.alert('식단 알림', '식단 알림 설정 화면 연결')}>
            <Ionicons name="restaurant-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>식단 알림</Label>
          ...
          <RowPress onPress={() => Alert.alert('진행 상황 알림', '주간 리포트 알림 설정')}>
            <Ionicons name="trending-up-outline" size={18} color="#99B7E8" />
            <LabelCol>
          ...
          <RowPress onPress={() => Alert.alert('건강 팁 알림', '건강 팁 알림 설정')}>
            <Ionicons name="medkit-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>건강 팁 알림</Label>
        ...
        <Card>
          <TitleRow>
            <Ionicons name="ellipsis-horizontal-circle-outline" size={16} color="#99B7E8" />
            <Title>기타</Title>
          </TitleRow>

          <RowPress onPress={() => (nav as any).navigate('PrivacyPolicy')}>
            <Ionicons name="shield-checkmark-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>개인정보 보호</Label>
          ...
          <RowPress onPress={() => (nav as any).navigate('Help')}>
            <Ionicons name="help-circle-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>도움말 및 지원</Label>
              <Desc>사용법 및 문의사항</Desc>
            </LabelCol>
          </RowPress>

          <RowPress onPress={() => Alert.alert('앱 정보', '버전 1.0.0')}>
            <Ionicons name="information-circle-outline" size={18} color="#99B7E8" />
            <LabelCol>
              <Label>앱 정보</Label>
              <Desc>버전 1.0.0</Desc>
            </LabelCol>
